...
**Live:** [canlı site](https://yuceldayan.vercel.app) · **API:** [yucel-portfolio-backend](https://github.com/Yuceldayan/yucel-portfolio-backend)
...
**Sole developer.** Design, build and deployment are mine, on both sides of the
wire: this client and the
